          ...
          {painPoints.map((point, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-ion-blue mb-2">
                {translations.painPoints[point.key as keyof typeof translations.painPoints].title}
              </h3>
              <p className="text-ion-dark/70">
                {translations.painPoints[point.key as keyof typeof translations.painPoints].description}
              </p>
            </div>
          ))}
        </div>
