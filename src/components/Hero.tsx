        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="md:w-1/2 md:pr-8 animate-fade-up">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-heading leading-tight mb-6">
              Reclaim Your Time.<br />Reimagine Your Company With AI.
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              ION Data empowers CEOs with personalized AI solutions and expert mentorship to drive unprecedented efficiency and growth.
            </p>
              ...
              <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 shadow-2xl">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <div className="text-white/80 font-medium">Time Saved on Repetitive Tasks</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <div className="text-4xl font-bold text-white mb-2">3x</div>
                    <div className="text-white/80 font-medium">Increased Strategic Planning Time</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <div className="text-4xl font-bold text-white mb-2">40%</div>
                    <div className="text-white/80 font-medium">Reduction in Decision Fatigue</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <div className="text-4xl font-bold text-white mb-2">60%</div>
                    <div className="text-white/80 font-medium">Faster Information Processing</div>
                  </div>
                </div>
              </div>
            </div>
